...
public class voirOrthoSlicerXZ : MonoBehaviour
{
    ...
    void Update()
    {
        if (maincontroll.SelectedMethod != VizMethods.OrthoSlicerXZ1) return;
    ...
    void Alloc()
    {
        ...
        //tindex = new int [(voirConst.OS_DIV-1)*(voirConst.OS_DIV-1)*2*3];
        pos = new double [3];
